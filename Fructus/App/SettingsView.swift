                ...
                VStack(spacing: 20) {
                    ...
                    GroupBox(
                        ...
                        HStack(alignment: .center, spacing: 10) {
                            ...
                            Text("Most fruits are naturaly low in fat, sodium and calories. None have cholesterol. Fruits are sources of many essential nutrients, including potassium, diettery fibre, vitamins, and much more")
                                .font(.footnote)
                        }
                    }
                    //MARK: - SECTION 2
...
Text("If you wish, you can restart the application by toggle the switch in this box. That way it starts the onboarding process and you will see the welcome screen again")
                    ...
                    GroupBox(
                        ...
                        SettingRowView(name: "Designer", content: "Robert / Peter")
